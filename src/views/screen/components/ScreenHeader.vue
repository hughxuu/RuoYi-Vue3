  ...
  >
    <div class="flex items-center gap-4 max-lg:ml-4 max-lg:text-left max-md:ml-0">
      <div class="hidden items-center gap-2 lg:flex">
        ...
        <i
          class="h-3 w-12 skew-x-[35deg] border-y border-screen-cyan/80 bg-[repeating-linear-gradient(135deg,transparent_0,transparent_0.25rem,rgba(32,181,241,0.8)_0.25rem,rgba(32,181,241,0.8)_0.5rem)]"
        />
      </div>
    ...
    <div
      class="absolute right-4 flex items-center gap-4 text-xs text-screen-muted max-lg:static max-lg:ml-auto max-lg:flex-wrap max-lg:justify-end max-md:ml-0"
    >
