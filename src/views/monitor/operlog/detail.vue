...
function copyText(str) {
  ...
  if (navigator.clipboard) {
    navigator.clipboard
      .writeText(text)
      .then(() => ElMessage({ message: '已复制', type: 'success', duration: 1500 }))
  } else {
...
<template>
  ...
  >
    <div class="detail-wrap">
        ...
        <el-row class="detail-row">
          <el-col :span="24">
            <div class="detail-item">
              ...
              <span class="detail-value">{{ form.operIp }}&nbsp;&nbsp;<span class="detail-location">{{
                form.operLocation
              }}</span></span>
            </div>
          </el-col>
          ...
          <el-col :span="24">
            <div class="detail-item">
              ...
              <span class="detail-value">
                <span :class="`method-tag method-${form.requestMethod}`">{{
                  form.requestMethod
                }}</span>
                {{ form.operUrl }}
              </span>
      ...
      <!-- 异常信息 -->
      <div v-if="form.status !== 0" class="detail-card">
